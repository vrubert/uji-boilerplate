...
import { javaPathHelper, pluralizeHelper } from './helpers'

handlebars.registerHelper('javaPath', javaPathHelper)
handlebars.registerHelper('pluralize', pluralizeHelper)
